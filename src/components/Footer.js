...
import{BsLinkedin, BsYoutube, BsInstagram, BsTwitter, BsGift} from "react-icons/bs";
const Footer = () => {
  return (
  <>
      ...
      <div className='container-xxl'>
        <div className='row'>
          <div className='col-4'>
            ...
            <div>
              <address className='text-white fs-5'>Hno : 122 Near High Court,<br/>
                Nanital, Uttarakhand<br/>
                Pincode: 263001
              </address>
              <a href='+91 8958957344' className='mt-3 d-block mb-1 text-white'>
                +91 8958957344
              </a>
              <a href='mailto:mohitgoswami24mg@gmail.com' 
                 className='mt-2 d-block mb-0 text-white'>
                mohitgoswami24mg@gmail.com
              </a>
